  ...
  return (
    <div className='flex flex-col overflow-'>
      <div className='flex items-center justify-center'>
        <div className='p-6 m-10 text-1xl border-2 border-slate-500 text-center w-[700px] rounded-[10px]'>
          <h1 className='text-7xl text-center mb-[20px]'>Abouts</h1>
           <p>Being one of the pioneer fintech clubs of the institute, established in 2018, the melange of projects and domains that we, as Profnitt, delve into has always been ever-expanding. With the vision to  inculcate healthy and fruitful discussions on markets and the economical state of the world and provides an opportunity to students to get practical experience in the markets.
            We also take part in competitions, fintech hackathons and symposiums in addition to conducting workshops and events to further the spirit of learning and growth among all.
          </p> 
        </div>
      </div>
