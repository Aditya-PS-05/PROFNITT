...
const MemberCard = () => {
  ...
  return (
    <div className="h-[250px] w-[270px] box-content bg-[#010D50] rounded-[10px] mt-10 border-2 border-red-500 m-4 relative hover:cursor-pointer grid-item">
      <div className="projects w-full h-full absolute z-0">
      ...
      <div className="projinks w-full h-full border-green-500 border-2 absolute z-10">
