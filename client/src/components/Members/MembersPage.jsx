        ...
        <div className="border-red-500 border-2 m-6 box-content w-screen h-screen flex flex-col" style={{ paddingTop: '80px' }}>
          ...
          <div className="border-red-500 border-2 flex justify-center items-center gap-[2vw] h-[150px]">
              <div className="border-red-500 border-2 h-full flex justify-center items-center font-DMSans">
                <button className="border-2 border-red-500 h-[70%] w-[120px] flex justify-center items-center hover:cursor-pointer m-4 hover:bg-white hover:text-black" onClick={getCore}>Core</button>
                <button className="border-2 border-red-500 h-[70%] w-[120px] flex justify-center items-center hover:cursor-pointer m-4 hover:bg-white hover:text-black" onClick={getAnalyst}>Analyst</button>
                <button className="border-2 border-red-500 h-[70%] w-[120px] flex justify-center items-center hover:cursor-pointer m-4 hover:bg-white hover:text-black" onClick={getJrAnalyst}>Junior Analyst</button>
              </div>
          </div>
