...
const Main = () => {
    ...
    return (
        <main className='md:h-screen md:flex justify-between items-center relative z-[1000] mb-12 pt-[85px]'>
            ...
            <div className='text-white h-full ml-[6vw] md:w-[40%] sm:w-full flex justify-start items-center z-[2000000] '>
                <div className='w-[75%] sm:mt-10 mt-6 md:mt-0 md:ml-10 z-[100000]'>
            ...
            <div className='w-full h-full sm:mt-10 md:w-[45%] relative z-[2000000]'>
                <div className="bg-[url('/images/laptop_body.svg')] h-[87%] ml-[130px] flex bg-no-repeat justify-end bg-right border-none rounded-t-[10px] bg-cover relative z-[1000] mt-4">
